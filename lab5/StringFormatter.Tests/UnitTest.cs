...
public class Tests
{
    ...
    {
        var user = new User("Петя", "Мирный");
        var temp = impl.StringFormatter.Shared.Format("Привет,{{ }}{FirstName} {LastName}!", user);
        Assert.That(temp, Is.EqualTo("Привет,{ }Петя Мирный!"));
    }
    ...
    public void String_Formatter_Example()
    {
        ...
        Assert.That(temp, Is.EqualTo("{FirstName} транслируется в Петя"));
    }
    ...
    {
        var user = new User("Петя", "Мирный");
        Assert.That(user.GetGreeting(), Is.EqualTo("Привет, Петя Мирный!"));
    }
    ...
    public void String_Formatter_Field_Among_Escapes()
    {
        ...
        Assert.That(temp, Is.EqualTo("{{{Мирный}}}"));
    }
